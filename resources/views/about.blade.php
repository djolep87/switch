...
<section class="py-0 py-lg-4">
    <div class="container">
        ...
        <p>Sa Trange Frange, vaša svakodnevna aktivnost postaje deo većeg pokreta za očuvanje planete i gradnju bolje budućnosti za sve nas. Pridružite nam se danas i budite deo pozitivne promene!</p>
        <p>Hvala vam što ste deo našeg puta ka održivijoj budućnosti. Učinimo svet boljim mestom zajedno!</p>
    </div>
</section>
<section class="py-4">
    <div class="container">
