        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-header small text-uppercase">
              <span class="menu-header-text">Upravljanje</span>
            </li>
            ...
            <li class="menu-item {{ request()->routeIs('admin.users') ? 'active' : '' }}">
              <a href="{{ route('admin.users') }}" class="menu-link">
                ...
                <div data-i18n="Users">Korisnici</div>
              </a>
            </li>
            ...
            <li class="menu-item {{ request()->routeIs('admin.products') ? 'active' : '' }}">
              <a href="{{ route('admin.products') }}" class="menu-link">
                ...
                <div data-i18n="Products">Oglasi</div>
              </a>
            </li>
            ...
            <li class="menu-item {{ request()->routeIs('admin.posts.*') ? 'active open' : '' }}">
              ...
              <ul class="menu-sub">
                <li class="menu-item {{ request()->routeIs('admin.posts.index') ? 'active' : '' }}">
                  <a href="{{ route('admin.posts.index') }}" class="menu-link">
                    <div data-i18n="Posts List">Lista Postova</div>
                  </a>
                </li>
                <li class="menu-item {{ request()->routeIs('admin.posts.create') ? 'active' : '' }}">
                  <a href="{{ route('admin.posts.create') }}" class="menu-link">
                    <div data-i18n="Create Post">Kreiraj Post</div>
                  </a>
                </li>
              </ul>
            </li>
            ...
            <li class="menu-item {{ request()->routeIs('admin.offers') ? 'active' : '' }}">
              <a href="{{ route('admin.offers') }}" class="menu-link">
                ...
                <div data-i18n="Offers">Ponude</div>
              </a>
            </li>

            <!-- Divider -->
            <li class="menu-header small text-uppercase">
              <span class="menu-header-text">Navigacija</span>
            </li>
            ...
            <li class="menu-item">
              <a href="/" class="menu-link" target="_blank">
                ...
                <div data-i18n="Back to Site">Vrati se na sajt</div>
              </a>
            </li>
          </ul>
        </aside>
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li>
                      <a class="dropdown-item" href="/">
                        ...
                        <span class="align-middle">Vrati se na sajt</span>
                      </a>
                    </li>
                    <li>
                      <div class="dropdown-divider"></div>
                    ...
                    <li>
                      <a class="dropdown-item" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                        ...
                        <span class="align-middle">Odjavi se</span>
                      </a>
          ...
          <div class="content-wrapper">
            ...
            <footer class="content-footer footer bg-footer-theme">
              <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                ...
                <div>
                  <a href="/" class="footer-link me-4" target="_blank">Vrati se na sajt</a>
                </div>
              </div>
            </footer>
            <!-- / Footer -->
