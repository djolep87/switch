        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">admin - TF</span>
            </a>
          ...
          <ul class="menu-inner py-1">
              ...
              <ul class="menu-sub">
                  <li class="menu-item">
                    <a href="/admin/posts" class="menu-link">
                      <div data-i18n="Notifications">Blog list</div>
                    </a>
                  </li>
                    <li class="menu-item">
                      <a href="/admin/posts/create" class="menu-link">
                        <div data-i18n="Account">Create blog</div>
                      </a>
                    </li>
                <li class="menu-item">
              ...
              <ul class="menu-sub">
                  <li class="menu-item">
                    <a href="/admin/users" class="menu-link">
                      <div data-i18n="Notifications">User list</div>
                    </a>
                  </li>
                    <li class="menu-item">
            ...
            <li class="menu-item">
              <a href="/admin.blog.create" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-dock-top"></i>
                <div data-i18n="Account Settings">Oglasi</div>
              </a>
              <ul class="menu-sub">
                  <li class="menu-item">
                    <a href="/admin/products" class="menu-link">
                      <div data-i18n="Notifications">Lista oglasa</div>
                    </a>
                  </li>
                    <li class="menu-item">
                      <a href="/admin/blog/create" class="menu-link">
