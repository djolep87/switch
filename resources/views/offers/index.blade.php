                        ...
                        <div class="card shadow-none mb-3 mb-lg-0 border">
                            <div class="card-body">
                                <div class="list-group list-group-flush"> <a href="/dashboard"
                                    ...
                                    <a href="/offers"
                                        class="list-group-item d-flex active justify-content-between align-items-center">Ponude
                                            ...
                                            <div class="tab-content pt-3">
                                                ...
                                                @else
                                                    @foreach ($offers as $offer)
                                                        @if (!$offer->offer_archived == 1)
                                                            ...
                                                            <div class="product-grid border-1">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="col">
                                                                        <p class="text-center">{{ $offer->user->firstName }}
                                                                        </p>
                                                                        <div class="card rounded-0 product-card">
                                                                            ...
                                                                            @if ($offer->sendproduct)
                                                                                <a
                                                                                    href="{{ route('products.show', $offer->sendproduct->id) }}"><img
                                                                                        src="/storage/Product_images/{{ $sendPproductImages[0] }}"
                                                                                        class="card-img-top"
                                                                                        alt=""></a>
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <div class="mb-1 product-price">
                                                                                                ...
                                                                                                <img width="16px"
                                                                                                    ...
                                                                                                    alt=""
                                                                                                    srcset="">
                                                                                                {{ $offer->sendproduct->user->phone ?? 'no client' }}
                                                                                                <br>
                                                                                                <img width="16px"
                                                                                                    src="/assets/images/location.svg"
                                                                                                    alt=""
                                                                                                    srcset="">
                                                                                                {{ $offer->sendproduct->user->city ?? 'no client' }}
                                                                                            </div>
                                                                                            <div
                                                                    ...
                                                                    <div class="col">
                                                                        ...
                                                                        <div class="card rounded-0 product-card">
                                                                            ...
                                                                            @if ($offer->product)
                                                                                <a
                                                                                    href="{{ route('products.show', $offer->product->id) }}"><img
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <div class="mb-1 product-price">
                                                                                                <img width="16px"
                                                                                                    ...
                                                                                                    alt=""
                                                                                                    srcset="">
                                                                                                {{ $offer->product->user->firstName ?? 'no client' }}
                                                                                                <br>
                                                                                                <img width="16px"
                                                                                                    src="/assets/images/phone.svg"
                                                                                                    alt=""
                                                                                                    srcset="">
                                                                                                {{ $offer->product->user->phone ?? 'no client' }}
                                                                                                <br>
                                                                                                <img width="16px"
                                                                                                    src="/assets/images/location.svg"
                                                                                                    alt=""
                                                                                                    srcset="">
                                                                                                {{ $offer->product->user->city ?? 'no client' }}
                                                                                            </div>
                                                                                            <div
                                                                                                class="cursor-pointer ms-auto">
                                                                    ...
                                                                    <div class="d-grid gap-2">
                                                                        @if ($offer->accepted == 0)
                                                                            @if ($offer->product && $offer->sendproduct)
                                                                                <div class="row">
                                                                                    <form
                                                                                        class="d-grid gap-2 col-6 p-0 m-0"
                                                                                        action="{{ url('offers.update', $offer->id) }}"
                                                                                        method="POST">
                                                                                        {{ csrf_field() }}
                                                                                        {{ method_field('post') }}
                                                                                        <input type="hidden"
                                                                                            ...
                                                                                            value="1">
                                                                                        <button
                                                                                            class="btn btn-success btn-sm rounded-0 m-0 btn-ecomm"
                                                                                            type="submit"><img
                                                                                    ...
                                                                                    <form
                                                                                        class="d-grid gap-2 col-6 p-0 m-0"
                                                                                        action="{{ url('offers.rejected', $offer->id) }}"
                                                                                        method="POST">
                                                                                        {{ csrf_field() }}
                                                                                        {{ method_field('post') }}
                                                                                        <input type="hidden"
                                                                                        ...
                                                                                        <button
                                                                                            class="btn btn-danger btn-sm rounded-0 m-0 btn-ecomm"
                                                                                            type="submit"><img
                                                                        ...
                                                                        @if ($offer->accepted == 2)
                                                                            ...
                                                                            <form class="d-grid gap-2  p-0 m-0"
                                                                                action="{{ route('offers.offer_archived', $offer->id) }}"
                                                                                method="POST">
                                                                                {{ csrf_field() }}
                                                                                <input type="hidden"
                                                                                    name="offer_archived" value="1">
                                                                                <button
                                                                                    style="border:none; transparent:none;"
                                                                                    type="submit">
                                                                                    <img style="width: 16px"
                                                                            ...
                                                                            @if ($offer->product)
                                                                                ...
                                                                                <div class="row">
                                                                                    <button type="button"
                                                                                        ...
                                                                                        korisnika</i></button>
                                                                                    <form
                                                                                        class="d-grid gap-2  p-0 m-0 col-6"
                                                                                        action="{{ route('offers.offer_archived', $offer->id) }}"
                                                                                        method="POST">
                                                                                        {{ csrf_field() }}
                                                                                        <input type="hidden"
                                                        ...
                                                        @endif
                                                        @if ($offer->product && $offer->sendproduct)
                                                            <div class="modal fade" id="exampleModal{{ $offer->id }}"
                                                                ...
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <form
                                                                                action="{{ route('comments.store', $offer->id) }}"
                                                                                method="POST"
                                                                                ...
                                                                                <div class="mb-3">
                                                                                    ...
                                                                                    <input type="hidden"
                                                                                        ...
                                                                                        value="{{ $offer->sendproduct->user_id ?? 'no client' }}">
                                                                                        ...
                                                                                        @if (Auth::user()->id == $offer->sendproduct->user_id)
                                                                                            <div class="like">
                                                                                                <button
                                                                                                    ...
                                                                                                    data-user-id="{{ $offer->sendproduct->user_id }}"><img
                                                                                                        src="/assets/images/thumbs-up.svg"
                                                                                                        alt="">
                                                                                                    <span id="count"
                                                                                                        class="like-count">{{ $offer->sendproduct->user->likes() }}</span></button>
                                                                                                <button
                                                                                                    style="transition: none; border: none;"
                                                                                                    type="button" disabled
                                                                                                    id="btn"
                                                                                                    ...
                                                                                                    data-user-id="{{ $offer->sendproduct->user_id }}"><img
                                                                                                        ...
                                                                                                        alt="">
                                                                                                    <span id="count"
                                                                                                        class="dislike-count">{{ $offer->sendproduct->user->dislikes() }}</span></button>
                                                                                            </div>
                                                                                        @else
                                                                                            <div class="like">
                                                                                                <button
