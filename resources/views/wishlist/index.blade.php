                        ...
                        <div class="card shadow-none mb-3 mb-lg-0 border rounded-0">
                            <div class="card-body">
                                <div class="list-group list-group-flush"> <a href="/dashboard"
                                    ...
                                    <a href="/wishlist"
                                        class="list-group-item active d-flex justify-content-between align-items-center">Oglasi
                                                        ...
                                                        <tbody>
                                                            @foreach ($wishlists as $item)
                                                                @php
                                                                    ...
                                                                    if (
                                                                        $item->products !== null &&
                                                                        null !== $item->products->images
                                                                    ) {
                                                                        $wishlistImages = explode(
                                                                            ',',
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        @if ($item->products)
                                                                            <div class=""><a
                                                                                href="{{ route('products.show', $item->products->id) }}"><img
                                                                                    src="/storage/Product_images/{{ $wishlistImages[0] }}"
                                                                    ...
                                                                    <td>
                                                                        @if ($item->products)
                                                                            <a
                                                                                href="{{ route('products.show', $item->products->id) }}">{{ $item->products->name }}</a>
                                                                        @else
                                                                    ...
                                                                    <td>
                                                                        <form action="/wishlist.destroy/{{ $item->id }}"
